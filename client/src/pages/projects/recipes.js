  ...
  return (
    <div className="project_page">
      <div className="project_page_card">
        ...
        <p className="project_text">
          On this project, I was responsible for the building the PSQL database
          and its models as well as constructing the Express/Node server and
          routes. I also designed the logo and styled the application with
          custom CSS.
        </p>
