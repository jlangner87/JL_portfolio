const About = () => {
  return (
    ...
    <div className="about">
      ...
      <p className="content_text">My first <em>big boy job</em> was as an electronics technician a cellular company. Over the years, I continually adapted to the rapidly changing industry. I went from hardware repair to software maintenance to user support. I even taught a smart device class for senior citizens in my community.</p>
      <p className="content_text">Over time, my interests shifted to software. I kept asking myself,
      <em>Where did this come from?</em>
      <em>If I developed this, what could I improve?</em></p>
